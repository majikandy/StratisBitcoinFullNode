...
namespace SphereD
{
    ...
    {
        /// <summary> Sphere maximal value for the calculated time offset. If the value is over this limit, the time syncing feature will be switched off. </summary>
        ...
        /// <summary> The default name used for the Sphere configuration file. </summary>
        public const string SphereDefaultConfigFilename = "Sphere.conf";

        public SphereMainNetwork()
        {
            ...
            this.RootFolderName = SphereRootFolderName;
            this.DefaultConfigFilename = SphereDefaultConfigFilename;
            this.MaxTimeOffsetSeconds = 25 * 60;
            this.CoinTicker = "SPHERE";
            ...
            Block genesisBlock = CreateSphereGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward);
            ...
            {
                //new DNSSeedData("seednode1.sphereplatform.com", "seednode1.sphereplatform.com"),
                //new DNSSeedData("seednode2.sphere.cloud", "seednode2.sphere.cloud"),
                //new DNSSeedData("seednode3.sphereplatform.com", "seednode3.sphereplatform.com"),
